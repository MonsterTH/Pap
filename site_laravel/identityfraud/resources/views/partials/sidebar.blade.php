<aside class="fade-up fade-up-d1 w-64 bg-brand-card p-6 flex flex-col">
    ...
    <nav class="flex-1">
        ...
        <div class="fade-up fade-up-d1">
            ...
            <a href="{{ route('admin.players.manage') }}"  class="block px-3 py-2 rounded hover:bg-white/10">Gerir</a>
            ...
            <a href="{{ route('admin.players.consulta') }}" class="block px-3 py-2 rounded hover:bg-white/10">Consultar</a>
        </div>
        ...
        <div class="fade-up fade-up-d2">
            ...
            <a href="{{ route('season.create') }}" class="block px-3 py-2 rounded hover:bg-white/10">Temporadas</a>
        </div>

        <div class="fade-up fade-up-d3">
            <h3 class="text-brand-accent font-bold mt-6 mb-2">Misc</h3>
            <a href="{{ route('seasons.index') }}" class="block px-3 py-2 rounded hover:bg-white/10">Histórico de Temporadas</a>
