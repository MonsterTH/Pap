...
<section class="relative min-h-screen overflow-hidden">
    ...
    <div class="relative max-w-5xl mx-auto px-4 md:px-8 py-16">
                    ...
                    <div class="flex flex-wrap gap-6 text-sm">
                        @if(isset($player->created_at))
                            <div class="flex items-center gap-2 text-brand-muted">
                                ...
                                Participante desde {{ $player->created_at->format('M Y') }}
                            </div>
                        @endif
        ...
        {{-- Stats grid --}}
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8 fade-up fade-up-d2">
            @php
                $stats = [
                    [
                    ...
                    [
                        'label' => 'Bounties Vencidas',
                        'value' => $player->completed_bounties_count ?? '—',
                    ...
                    [
                        'label' => 'Notícias',
                        'value' => $player->news_count ?? '—',
                        'link' => route('players.news', $player->id),
                        'icon' => 'M19 5H5a2 2 0 00-2 2v10a2 2 0 002 2h14a2 2 0 002-2V7a2 2 0 00-2-2zm0 0l-7 5-7-5'
                    ],
                ];
            @endphp
