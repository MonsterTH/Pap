...
<section class="max-w-7xl mx-auto px-4 md:px-8 py-16">
    ...
    <div class="fade-up fade-up-d1 text-center mb-12">
        ...
        <h1 class="mt-4 text-4xl md:text-6xl font-extrabold font-display">
            Conhece os <span class="text-transparent bg-clip-text bg-gradient-to-r from-brand-accent to-brand-gold">Participantes</span>
        </h1>
    ...
    <div id="playersGrid" class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        @foreach($players as $player)
                ...
                <!-- NOME -->
                <h2 class="fade-up fade-up-d3 text-lg font-bold text-white">
                    {{ $player->name }}
                </h2>
