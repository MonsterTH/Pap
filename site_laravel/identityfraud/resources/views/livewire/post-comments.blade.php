    ...
    @foreach($comments as $comment)
        <div class="bg-brand-card border border-white/5 rounded-xl p-4">
                    ...
                    <div class="flex items-center gap-3 mb-2">
                        <img class="w-8 h-8 rounded-full bg-white/10" src="{{ $comment->user->profile_picture ? asset('storage/' . $comment->user->profile_picture) : asset('storage/images/default.png') }}">
                        <div>
