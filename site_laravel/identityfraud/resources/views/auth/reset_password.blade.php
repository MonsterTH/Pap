    ...
    <form method="POST" action="{{ route('password.update') }}">
        ...
        <div class="mb-3">
            <input
                ...
                value="{{ request()->email }}"
                readonly
                class="w-full px-3 py-2 rounded bg-brand-dark border border-brand-muted text-brand-light opacity-70 cursor-not-allowed focus:outline-none focus:ring-2 focus:ring-brand-accent focus:border-brand-accent">
        </div>
